const projectData = [
  {
    ...
    blocks: [{ pos: 0, text: "Built as a full-stack site that demonstrates end-to-end engineering (React UI, API-backed content, deployment, and security hardening). Start here to see how I design, ship, and maintain a production-ready system rather than a static demo." }],
    metadata: {
      index: {
