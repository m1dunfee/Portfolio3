const prospectData = [
  {
    ...
    metadata: {
      ...
      index: {
        ...
        tech: [],
        skill: ["MLAndModeling", "SystemDesignAndArchitecture", "DocumentationAndCommunication", "SecurityPractices"],
      },
    },
  },

  {
    ...
    metadata: {
      ...
      index: {
        discipline: ["DataAndAI"],
        tech: ["CRISPR"],
        skill: ["DataAndDatabases", "MLAndModeling", "DocumentationAndCommunication"],
      },
    },
  },

  {
    ...
    metadata: {
      ...
      status: "",
      index: {
        discipline: ["Security", "SystemsAndNetworking"],
        tech: ["Wireshark"],
        skill: ["SecurityPractices", "NetworkingFundamentals", "DebuggingAndTroubleshooting"],
      },
    },
  },

  {
    ...
    metadata: {
      ...
      index: {
        ...
        tech: [],
        skill: ["TestingAndQuality", "DebuggingAndTroubleshooting", "SystemDesignAndArchitecture", "AlgorithmsAndProblemSolving"],
      },
    },
  },

  {
    ...
    metadata: {
      ...
      index: {
        ...
        skill: ["APIAndBackend", "DataAndDatabases", "TestingAndQuality", "DebuggingAndTroubleshooting", "SystemDesignAndArchitecture", "DocumentationAndCommunication"],
      },
    },
  },

  {
    ...
    metadata: {
      ...
      status: "",
      index: {
        discipline: ["DevOpsAndOperations", "SystemsAndNetworking", "Security"],
        tech: ["Docker", "Nginx", "Linux", "MongoDB", "Cloudflare"],
        skill: ["DevOpsAndDeployment", "Containerization", "NetworkingFundamentals", "ReliabilityAndMonitoring", "DebuggingAndTroubleshooting", "SecurityPractices"],
      },
    },
  },

  {
    ...
    metadata: {
      ...
      index: {
        ...
        skill: ["DataAndDatabases", "MLAndModeling", "DocumentationAndCommunication", "TestingAndQuality"],
      },
    },
  },
];
